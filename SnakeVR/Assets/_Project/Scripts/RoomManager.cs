...
namespace Gustorvo.SnakeVR
{
    ...
    public class RoomManager : MonoBehaviour
    {
        ...
        private void OnSceneLoaded()
        {
            ...
            float height = room.Walls[0].Height - shrinkFactor;
            float width = room.Floor.Width - shrinkFactor;
            float depth = room.Floor.Height - shrinkFactor;
            ...
            OnRoomBoundsSet?.Invoke(roomBounds.bounds);
        }
